    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "abruno36-admin@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 99393-6883",
                FirstName = "Bruno",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Abt0389123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "abruno36-client@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 99393-6883",
                FirstName = "Bruno",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Abt0389123$").GetAwaiter().GetResult();
